...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.25 1.75V3.25H9.25V1.75H12.25ZM4.75 1.75V6.25H1.75V1.75H4.75ZM12.25 7.75V12.25H9.25V7.75H12.25ZM4.75 10.75V12.25H1.75V10.75H4.75ZM13.75 0.25H7.75V4.75H13.75V0.25ZM6.25 0.25H0.25V7.75H6.25V0.25ZM13.75 6.25H7.75V13.75H13.75V6.25ZM6.25 9.25H0.25V13.75H6.25V9.25Z" fill="#209EA4" />
</svg>')
->link->attr(['class' => '']);
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.25 2H11.5V0.5H10V2H4V0.5H2.5V2H1.75C0.9175 2 0.2575 2.675 0.2575 3.5L0.25 14C0.25 14.825 0.9175 15.5 1.75 15.5H12.25C13.075 15.5 13.75 14.825 13.75 14V3.5C13.75 2.675 13.075 2 12.25 2ZM12.25 14H1.75V6.5H12.25V14ZM12.25 5H1.75V3.5H12.25V5ZM7 8.75H10.75V12.5H7V8.75Z" fill="#209EA4" />
</svg>')
->nickname('booking')
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.25 7.75V4.75C5.25 4.3375 4.9125 4 4.5 4H1.5V2.5H5.25V1H3.375V0.25H1.875V1H0.75C0.3375 1 0 1.3375 0 1.75V4.75C0 5.1625 0.3375 5.5 0.75 5.5H3.75V7H0V8.5H1.875V9.25H3.375V8.5H4.5C4.9125 8.5 5.25 8.1625 5.25 7.75Z" fill="#209EA4" />
    <path d="M11.6925 7.39001L7.44746 11.6275L5.32496 9.50501L4.26746 10.57L7.44746 13.75L12.75 8.44751L11.6925 7.39001Z" fill="#209EA4" />
</svg>')
->link->attr(['class' => '']);
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.5024 6.84747C13.5299 7.54497 14.2499 8.48997 14.2499 9.74997V12H17.2499V9.74997C17.2499 8.11497 14.5724 7.14747 12.5024 6.84747Z" fill="#209EA4" />
    <path d="M11.2499 6C12.9074 6 14.2499 4.6575 14.2499 3C14.2499 1.3425 12.9074 0 11.2499 0C10.8974 0 10.5674 0.0749998 10.2524 0.18C10.8749 0.9525 11.2499 1.935 11.2499 3C11.2499 4.065 10.8749 5.0475 10.2524 5.82C10.5674 5.925 10.8974 6 11.2499 6Z" fill="#209EA4" />
    <path d="M6.75 6C8.4075 6 9.75 4.6575 9.75 3C9.75 1.3425 8.4075 0 6.75 0C5.0925 0 3.75 1.3425 3.75 3C3.75 4.6575 5.0925 6 6.75 6ZM6.75 1.5C7.575 1.5 8.25 2.175 8.25 3C8.25 3.825 7.575 4.5 6.75 4.5C5.925 4.5 5.25 3.825 5.25 3C5.25 2.175 5.925 1.5 6.75 1.5Z" fill="#209EA4" />
    <path d="M6.75 6.75C4.7475 6.75 0.75 7.755 0.75 9.75V12H12.75V9.75C12.75 7.755 8.7525 6.75 6.75 6.75ZM11.25 10.5H2.25V9.7575C2.4 9.2175 4.725 8.25 6.75 8.25C8.775 8.25 11.1 9.2175 11.25 9.75V10.5Z" fill="#209EA4" />
</svg>')
->link->attr(['class' => '']);
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_2348_716)">
        <path d="M8 3.21865L12 6.81865V13.0667H10.4V8.26665H5.6V13.0667H4V6.81865L8 3.21865M8 1.06665L0 8.26665H2.4V14.6667H7.2V9.86665H8.8V14.6667H13.6V8.26665H16L8 1.06665Z" fill="#209EA4" />
    </g>
    <defs>
...
->data('role', 'admin')
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 3.5H14V5H2V3.5ZM3.5 0.5H12.5V2H3.5V0.5ZM14 6.5H2C1.175 6.5 0.5 7.175 0.5 8V14C0.5 14.825 1.175 15.5 2 15.5H14C14.825 15.5 15.5 14.825 15.5 14V8C15.5 7.175 14.825 6.5 14 6.5ZM14 14H2V8H14V14ZM6.5 8.5475V13.445L11 11L6.5 8.5475Z" fill="#209EA4" />
</svg>')
->link->attr(['class' => '']);
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3.875 7.5H2.375V12.75H3.875V7.5ZM8.375 7.5H6.875V12.75H8.375V7.5ZM14.75 14.25H0.5V15.75H14.75V14.25ZM12.875 7.5H11.375V12.75H12.875V7.5ZM7.625 2.445L11.5325 4.5H3.7175L7.625 2.445ZM7.625 0.75L0.5 4.5V6H14.75V4.5L7.625 0.75Z" fill="#209EA4" />
</svg>')
...
->prepend('<svg width="15" height="12" class="sidebar-menu-icon" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16.5 3.75V2.25H15V3.75H13.5V5.25H15V6.75H16.5V5.25H18V3.75H16.5Z" fill="#209EA4" />
    <path d="M6 6C7.6575 6 9 4.6575 9 3C9 1.3425 7.6575 0 6 0C4.3425 0 3 1.3425 3 3C3 4.6575 4.3425 6 6 6ZM6 1.5C6.825 1.5 7.5 2.175 7.5 3C7.5 3.825 6.825 4.5 6 4.5C5.175 4.5 4.5 3.825 4.5 3C4.5 2.175 5.175 1.5 6 1.5Z" fill="#209EA4" />
    <path d="M6 6.75C3.9975 6.75 0 7.755 0 9.75V12H12V9.75C12 7.755 8.0025 6.75 6 6.75ZM10.5 10.5H1.5V9.7575C1.65 9.2175 3.975 8.25 6 8.25C8.025 8.25 10.35 9.2175 10.5 9.75V10.5Z" fill="#209EA4" />
    <path d="M9.38245 0.0374985C10.0724 0.832498 10.4999 1.8675 10.4999 3C10.4999 4.1325 10.0724 5.1675 9.38245 5.9625C10.8524 5.775 11.9999 4.53 11.9999 3C11.9999 1.47 10.8524 0.224998 9.38245 0.0374985Z" fill="#209EA4" />
    <path d="M12.3975 7.3725C13.065 7.995 13.5 8.775 13.5 9.75V12H15V9.75C15 8.6625 13.8075 7.8675 12.3975 7.3725Z" fill="#209EA4" />
</svg>')
->nickname('handyman')
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_2357_751)">
        <path d="M8.84999 8.175C7.14749 7.7325 6.59999 7.275 6.59999 6.5625C6.59999 5.745 7.35749 5.175 8.62499 5.175C9.95999 5.175 10.455 5.8125 10.5 6.75H12.1575C12.105 5.46 11.3175 4.275 9.74999 3.8925V2.25H7.49999V3.87C6.04499 4.185 4.87499 5.13 4.87499 6.5775C4.87499 8.31 6.30749 9.1725 8.39999 9.675C10.275 10.125 10.65 10.785 10.65 11.4825C10.65 12 10.2825 12.825 8.62499 12.825C7.07999 12.825 6.47249 12.135 6.38999 11.25H4.73999C4.82999 12.8925 6.05999 13.815 7.49999 14.1225V15.75H9.74999V14.1375C11.2125 13.86 12.375 13.0125 12.375 11.475C12.375 9.345 10.5525 8.6175 8.84999 8.175Z" fill="#209EA4" />
    </g>
    <defs>
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_2357_776)">
        <path d="M3 13.5V13.0125C3 12.7575 3.12 12.5175 3.3075 12.405C4.575 11.6475 6.0225 11.25 7.5 11.25C7.5225 11.25 7.5375 11.25 7.56 11.2575C7.635 10.7325 7.785 10.23 8.0025 9.7725C7.8375 9.7575 7.6725 9.75 7.5 9.75C5.685 9.75 3.99 10.2525 2.5425 11.115C1.8825 11.505 1.5 12.24 1.5 13.0125V15H8.445C8.13 14.55 7.8825 14.04 7.7175 13.5H3Z" fill="#209EA4" />
        <path d="M7.5 9C9.1575 9 10.5 7.6575 10.5 6C10.5 4.3425 9.1575 3 7.5 3C5.8425 3 4.5 4.3425 4.5 6C4.5 7.6575 5.8425 9 7.5 9ZM7.5 4.5C8.325 4.5 9 5.175 9 6C9 6.825 8.325 7.5 7.5 7.5C6.675 7.5 6 6.825 6 6C6 5.175 6.675 4.5 7.5 4.5Z" fill="#209EA4" />
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_2357_765)">
        <path d="M8.25 9.75V6.75C8.25 6.3375 7.9125 6 7.5 6H4.5V4.5H8.25V3H6.375V2.25H4.875V3H3.75C3.3375 3 3 3.3375 3 3.75V6.75C3 7.1625 3.3375 7.5 3.75 7.5H6.75V9H3V10.5H4.875V11.25H6.375V10.5H7.5C7.9125 10.5 8.25 10.1625 8.25 9.75Z" fill="#209EA4" />
        <path d="M14.6925 9.39001L10.4475 13.6275L8.32496 11.505L7.26746 12.57L10.4475 15.75L15.75 10.4475L14.6925 9.39001Z" fill="#209EA4" />
    </g>
    <defs>
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M14 0H2C1.1675 0 0.5075 0.6675 0.5075 1.5L0.5 10.5C0.5 11.3325 1.1675 12 2 12H14C14.8325 12 15.5 11.3325 15.5 10.5V1.5C15.5 0.6675 14.8325 0 14 0ZM14 10.5H2V6H14V10.5ZM14 3H2V1.5H14V3Z" fill="#209EA4" />
</svg>
')
->nickname('payment')
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13.75 3.46V1.75C13.75 0.925 13.075 0.25 12.25 0.25H1.75C0.9175 0.25 0.25 0.925 0.25 1.75V12.25C0.25 13.075 0.9175 13.75 1.75 13.75H12.25C13.075 13.75 13.75 13.075 13.75 12.25V10.54C14.1925 10.2775 14.5 9.805 14.5 9.25V4.75C14.5 4.195 14.1925 3.7225 13.75 3.46ZM13 4.75V9.25H7.75V4.75H13ZM1.75 12.25V1.75H12.25V3.25H7.75C6.925 3.25 6.25 3.925 6.25 4.75V9.25C6.25 10.075 6.925 10.75 7.75 10.75H12.25V12.25H1.75Z" fill="#209EA4" />
    <path d="M10 8.125C10.6213 8.125 11.125 7.62132 11.125 7C11.125 6.37868 10.6213 5.875 10 5.875C9.37868 5.875 8.875 6.37868 8.875 7C8.875 7.62132 9.37868 8.125 10 8.125Z" fill="#209EA4" />
</svg>')
->nickname('wallet')
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15.94,10.179l-2.437-0.325l1.62-7.379c0.047-0.235-0.132-0.458-0.372-0.458H5.25c-0.241,0-0.42,0.223-0.373,0.458l1.634,7.376L4.06,10.179c-0.312,0.041-0.446,0.425-0.214,0.649l2.864,2.759l-0.724,3.947c-0.058,0.315,0.277,0.554,0.559,0.401l3.457-1.916l3.456,1.916c-0.419-0.238,0.56,0.439,0.56-0.401l-0.725-3.947l2.863-2.759C16.388,10.604,16.254,10.22,15.94,10.179M10.381,2.778h3.902l-1.536,6.977L12.036,9.66l-1.655-3.546V2.778z M5.717,2.778h3.903v3.335L7.965,9.66L7.268,9.753L5.717,2.778zM12.618,13.182c-0.092,0.088-0.134,0.217-0.11,0.343l0.615,3.356l-2.938-1.629c-0.057-0.03-0.122-0.048-0.184-0.048c-0.063,0-0.128,0.018-0.185,0.048l-2.938,1.629l0.616-3.356c0.022-0.126-0.019-0.255-0.11-0.343l-2.441-2.354l3.329-0.441c0.128-0.017,0.24-0.099,0.295-0.215l1.435-3.073l1.435,3.073c0.055,0.116,0.167,0.198,0.294,0.215l3.329,0.441L12.618,13.182z" fill="#209EA4" />
</svg>')
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_2412_1231)">
        <path d="M5 10H10V11.25H5V10ZM5 7.5H10V8.75H5V7.5ZM8.75 1.25H3.75C3.0625 1.25 2.5 1.8125 2.5 2.5V12.5C2.5 13.1875 3.05625 13.75 3.74375 13.75H11.25C11.9375 13.75 12.5 13.1875 12.5 12.5V5L8.75 1.25ZM11.25 12.5H3.75V2.5H8.125V5.625H11.25V12.5Z" fill="#209EA4" />
    </g>
    <defs>
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M14 1.5H8L6.5 0H2C1.175 0 0.5075 0.675 0.5075 1.5L0.5 10.5C0.5 11.325 1.175 12 2 12H14C14.825 12 15.5 11.325 15.5 10.5V3C15.5 2.175 14.825 1.5 14 1.5ZM14 10.5H2V1.5H5.8775L7.3775 3H14V10.5ZM12.5 6H3.5V4.5H12.5V6ZM9.5 9H3.5V7.5H9.5V9Z" fill="#209EA4" />
</svg>')
->link->attr(['class' => '']);
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M14.25 3.75V14.25H3.75V3.75H14.25ZM14.25 2.25H3.75C2.925 2.25 2.25 2.925 2.25 3.75V14.25C2.25 15.075 2.925 15.75 3.75 15.75H14.25C15.075 15.75 15.75 15.075 15.75 14.25V3.75C15.75 2.925 15.075 2.25 14.25 2.25Z" fill="#209EA4" />
    <path d="M10.5 12.75H5.25V11.25H10.5V12.75ZM12.75 9.75H5.25V8.25H12.75V9.75ZM12.75 6.75H5.25V5.25H12.75V6.75Z" fill="#209EA4" />
</svg>')
->nickname('document')
...
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M6.25 10.6275L4.6225 9L6.25 7.3725L5.1925 6.3075L2.5 9L5.1925 11.6925L6.25 10.6275Z" fill="#209EA4" />
    <path d="M8.8075 11.6925L11.5 9L8.8075 6.3075L7.75 7.3725L9.3775 9L7.75 10.6275L8.8075 11.6925Z" fill="#209EA4" />
    <path d="M12.25 2.25H9.115C8.8 1.38 7.975 0.75 7 0.75C6.025 0.75 5.2 1.38 4.885 2.25H1.75C1.645 2.25 1.5475 2.2575 1.45 2.28C1.1575 2.34 0.895 2.49 0.6925 2.6925C0.5575 2.8275 0.445 2.9925 0.37 3.1725C0.295 3.345 0.25 3.54 0.25 3.75V11.25V12V14.25C0.25 14.4525 0.295 14.655 0.37 14.835C0.445 15.015 0.5575 15.1725 0.6925 15.315C0.895 15.5175 1.1575 15.6675 1.45 15.7275C1.5475 15.7425 1.645 15.75 1.75 15.75H12.25C13.075 15.75 13.75 15.075 13.75 14.25V12V11.25V3.75C13.75 2.925 13.075 2.25 12.25 2.25ZM7 2.0625C7.3075 2.0625 7.5625 2.3175 7.5625 2.625C7.5625 2.9325 7.3075 3.1875 7 3.1875C6.6925 3.1875 6.4375 2.9325 6.4375 2.625C6.4375 2.3175 6.6925 2.0625 7 2.0625ZM12.25 11.25V12V14.25H1.75V12V11.25V3.75H12.25V11.25Z" fill="#209EA4" />
</svg>')
